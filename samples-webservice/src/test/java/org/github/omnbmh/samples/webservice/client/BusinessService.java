...
package org.github.omnbmh.samples.webservice.client;
 ...
 * 
 */
@WebServiceClient(name = "BusinessService", targetNamespace = "http://webservice.samples.omnbmh.github.org/client", wsdlLocation = "http://127.0.0.1:8888/BusineeService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BUSINESSSERVICE_QNAME = new QName("http://webservice.samples.omnbmh.github.org/client", "BusinessService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8888/BusineeService?wsdl");
    ...
    public Business getBusinessPort() {
        return super.getPort(new QName("http://webservice.samples.omnbmh.github.org/client", "BusinessPort"), Business.class);
    }
    ...
    public Business getBusinessPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.samples.omnbmh.github.org/client", "BusinessPort"), Business.class, features);
    }
