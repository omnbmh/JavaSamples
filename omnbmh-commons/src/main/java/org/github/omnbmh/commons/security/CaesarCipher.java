...
public class CaesarCipher {
	private static final char[] UC_ENCRYPT_CHARS =
	{ 'M', 'D', 'X', 'U', 'P', 'I', 'B', 'E', 'J', 'C', 'T', 'N', 'K', 'O', 'G', 'W', 'R', 'S', 'F', 'Y', 'V', 'L', 'Z', 'Q', 'A', 'H' };

	private static final char[] LC_ENCRYPT_CHARS =
	{ 'n', 'd', 'x', 'u', 'q', 'i', 'b', 'e', 'j', 'c', 't', 'm', 'k', 'o', 'g', 'w', 'r', 's', 'f', 'y', 'v', 'l', 'z', 'p', 'a', 'h' };
